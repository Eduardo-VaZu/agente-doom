...
def make_doom_env(config: LegacyConfigPayload, record: bool = False) -> VecEnv:
    profile_payload: LegacyConfigPayload = {
        ...
        "total_timesteps": config.get("total_timesteps", 750000),
        ...
        "video_length": config.get("video_length", 1500),
    ...
    training_payload: TrainingProfilePayload = {
        ...
        "batch_size": profile_payload.get("batch_size", 128),
        "n_epochs": profile_payload.get("n_epochs", 8),
        "gamma": profile_payload.get("gamma", 0.99),
        "gae_lambda": profile_payload.get("gae_lambda", 0.95),
        "ent_coef": profile_payload.get("ent_coef", 0.005),
        "requested_timesteps": profile_payload.get("total_timesteps", 750000),
        ...
        "video_length": profile_payload.get("video_length", 1500),
        ...
        "observation_mode": profile_payload.get("observation_mode", "vision"),
        "seed": profile_payload.get("seed", 42),
        "action_combo_preset": profile_payload.get("action_combo_preset", "default"),
