...
| `basic_audio` | Cerrado provisional | Regular | `doom_foundation_agent__basic_audio_promoted.zip` | `mean_reward = -64.84`, `std = 111.19` | Refuerzo post-curriculum (+301k steps, 2026-07-15) empeoro a `mean_reward=-78.68`, `std=124.69`; no promovido, checkpoint oficial sin cambios. Mas steps con la misma config no resuelve la inestabilidad. |
| `basic_notifications` | Cerrado provisional | Regular | `doom_foundation_agent__basic_notifications_promoted.zip` | `mean_reward = -73.60`, `std = 120.65` | Refuerzo post-curriculum (+301k steps, 2026-07-15) empeoro a `mean_reward=-116.48`, `std=143.67`; no promovido, checkpoint oficial sin cambios. Mismo patron que `basic_audio`. |
